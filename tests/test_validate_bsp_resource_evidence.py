...
def make_evidence(directory: Path) -> Path:
    messages = [
        ...
        "RESOURCE_PIPELINES_READY count=2 map=bsp_resource overlay=bsp_overlay map_gs_words=2 overlay_gs_words=1",
        ...
        "RESOURCE_FRAME_READY frame=0 slot=0 transient_bytes=95360 constant_dwords=32 texture_descriptor_dwords=3936 overlay_vertices=4 overlay_indices=6 acquire_engine=1 gcr=00009000 poll_cycles=190 tables_gpu_span=true",
        ...
        "RESOURCE_FRAME_READY frame=59999 slot=1 transient_bytes=95360 constant_dwords=32 texture_descriptor_dwords=3936 overlay_vertices=4 overlay_indices=6 acquire_engine=1 gcr=00009000 poll_cycles=190 tables_gpu_span=true",
