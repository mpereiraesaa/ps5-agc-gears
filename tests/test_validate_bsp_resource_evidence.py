...
def make_evidence(directory: Path) -> Path:
    messages = [
        ...
        "RESOURCE_FRAME_READY frame=0 slot=0 transient_bytes=95360 constant_dwords=32 texture_descriptor_dwords=3936 overlay_vertices=4 overlay_indices=6 gcr=00004380 tables_gpu_span=true",
        ...
        "RESOURCE_FRAME_READY frame=59999 slot=1 transient_bytes=95360 constant_dwords=32 texture_descriptor_dwords=3936 overlay_vertices=4 overlay_indices=6 gcr=00004380 tables_gpu_span=true",
