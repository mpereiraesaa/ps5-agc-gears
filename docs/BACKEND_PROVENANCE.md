...
| `include/ps5_platform.h` | Declares the minimal kernel, VideoOut and sysmodule surface and its opaque record layouts. | Compile-time sizes/offsets match the FW 12.02 hardware-used integration; it is explicitly a clean-room compatibility header. |
